...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LY_CL] = LAYOUT_planck_grid(
    KC_Q,     KC_W,      KC_F,      KC_P,       KC_G,        ___, /**/ ___, KC_J,         KC_L,      KC_U,      KC_Y,      TD(QO_GR),
  ...
  [LY_SY] = LAYOUT_planck_grid(
    ...
    KC_TAB,   KC_PERC,   ___,       KC_HASH,    ___,         ___, /**/ ___, KC_CIRC,      KC_LCBR,   KC_RCBR,   KC_LBRC,   KC_RBRC,
  ...
  [LY_OS] = LAYOUT_planck_grid(
    ...
    ___,      ___,       ___,       TO(LY_FN),  ___,         ___, /**/ ___, KC_PWR,       TO(LY_CL), ___,       ___,       ___
  ),
