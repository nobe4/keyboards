...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LY_CL] = LAYOUT_planck_grid(
    ...
    TD(Z_AST),  TD(X_PRC), TD(C_AT), TD(V_CIR), _MG(KC_B), ___, /**/ ___, TD(K_AMP),    TD(M_UND),  TD(CO_QES), TD(DO_EX), KC_ENT,
    ___,        ___,       ___,      KC_LSFT,   KC_SPC,    ___, /**/ ___, _MC(KC_BSPC), OSL(LY_SY), ___,        ___,       ___
  ),
  [LY_SY] = LAYOUT_planck_grid(
    KC_0,       KC_1,      KC_2,     KC_3,      KC_PLUS,   ___, /**/ ___, KC_LPRN,      KC_RPRN,    KC_LBRC,    KC_RBRC,   KC_COLN,
    KC_ESC,     KC_4,      KC_5,     KC_6,      KC_EQL,    ___, /**/ ___, KC_LEFT,      KC_DOWN,    KC_UP,      KC_RGHT,   KC_SCLN,
    KC_TAB,     KC_8,      KC_8,     KC_9,      KC_MINS,   ___, /**/ ___, KC_LCBR,      KC_RCBR,    KC_BSLS,    KC_PIPE,   KC_SLSH,
  ...
  [LY_OS] = LAYOUT_planck_grid(
    ...
    KC_F11,     KC_F12,    ___,      ___,       ___,       ___, /**/ ___, KC_VOLD,      ___,        ___,        ___,       ___,
    ___,        ___,       ___,      TO(LY_CL), ___,       ___, /**/ ___, KC_LCTL,      ___,        ___,        ___,       ___
  ),
};
// clang-format on
