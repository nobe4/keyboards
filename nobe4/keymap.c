...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LY_CL] = LAYOUT_planck_grid(
    TD(Q_HASH), KC_W,      KC_F,      TD(P_PRC), KC_G,        ___, /**/ ___, KC_J,         KC_L,       KC_U,      KC_Y,      TD(QO_GR),
    TD(A_AT),   TD(R_AMP), TD(S_DLR), KC_T,      KC_D,        ___, /**/ ___, KC_H,         KC_N,       KC_E,      KC_I,      TD(O_SCL),
    KC_Z,       KC_X,      KC_C,      KC_V,      _MG(KC_B),   ___, /**/ ___, KC_K,         KC_M,       TD(CO_UD), TD(DO_EX), TD(SL_BL),
    ___,        ___,       ___,       KC_ENT,    _MS(KC_SPC), ___, /**/ ___, _MC(KC_BSPC), OSL(LY_SY), ___,       ___,       ___
  ),
  [LY_SY] = LAYOUT_planck_grid(
    ...
    KC_TAB,     ___,       ___,       ___,       ___,         ___, /**/ ___, KC_CIRC,      KC_LCBR,    KC_RCBR,   KC_LBRC,   KC_RBRC,
    ___,        ___,       ___,       TO(LY_CL), KC_LSFT,     ___, /**/ ___, KC_DEL,       TO(LY_OS),  ___,       ___,       ___
  ),
  [LY_OS] = LAYOUT_planck_grid(
    ___,        ___,       ___,       ___,       ___,         ___, /**/ ___, ___,          ___,        ___,       ___,       ___,
    ___,        KC_MUTE,   KC_VOLD,   KC_VOLU,   ___,         ___, /**/ ___, KC_LEFT,      KC_DOWN,    KC_UP,     KC_RGHT,   ___,
    ___,        KC_MRWD,   KC_MPLY,   KC_MFFD,   ___,         ___, /**/ ___, ___,          ___,        ___,       ___,       ___,
    ___,        ___,       ___,       TO(LY_CL), ___,         ___, /**/ ___, KC_LCTL,      TO(LY_FN),  ___,       ___,       ___
  ),
