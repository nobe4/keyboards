...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_CL] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_LGUI, MO(_SY), KC_SPC, KC_BSPC,  MO(_OS), KC_RGUI, KC_RALT, KC_RCTL, DF(_QW)
  ),
  [_QW] = LAYOUT_planck_grid(
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    _______,
    KC_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
    KC_LCTL, KC_LGUI, KC_LALT, KC_LGUI, MO(_SY), KC_SPC, KC_BSPC,  MO(_OS), KC_RGUI, KC_RALT, KC_RCTL, DF(_CL)
  ),
