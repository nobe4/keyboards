...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_CL] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_LGUI,   KC_LALT,   KC_LGUI,   MO(_SY),   KC_SPC,  KC_SPC,  MO(_OS),   KC_RGUI,   KC_RALT,   OSL(_QW),  DF(_QW)
  ),
  ...
  [_SY] = LAYOUT_planck_grid(
    ...
    KC_0,    KC_AT,     KC_AMPR,   KC_ASTR,   KC_EXLM,   KC_UNDS, KC_MINS, KC_PLUS,   KC_EQL,    KC_LPRN,   KC_RPRN,   _______,
