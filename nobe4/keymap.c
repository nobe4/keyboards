...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_CL] = LAYOUT_planck_grid(
    ...
    _______, KC_Z,      KC_X,      KC_C,      KC_V,      KC_B,    KC_K,    KC_M,      KC_COMM,   KC_DOT,    KC_SLSH,   KC_ENT,
    _______, _______,   _______,   _______,   MO(_SY),   KC_SPC,  KC_BSPC, MO(_OS),   _______,   _______,   _______,   DF(_QW)
  ),
  [_SY] = LAYOUT_planck_grid(
    ...
    _______, KC_GRV,    KC_PERC,   KC_DLR,    KC_HASH,   KC_BSLS, KC_CIRC, KC_LCBR,   KC_RCBR,   KC_LBRC,   KC_RBRC,   _______,
