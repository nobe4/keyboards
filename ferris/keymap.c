...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LY_CL] = LAYOUT(
    ...
    KC_A,       KC_R,      KC_S,     KC_T,        KC_D,    /**/ TD(H_AC),  KC_N,      KC_E,       KC_I,      KC_O,
    TD(Z_AST),  TD(X_PRC), TD(C_AT), TD(V_CIR),   B_GUI,   /**/ TD(K_AMP), TD(M_UND), TD(CO_QES), TD(DO_EX), KC_ENT,
    /*,         ,          ,         */KC_LSFT,   KC_SPC,  /**/ BSP_CTL,   OSL(LY_SY)
  ),

  // see Plank for reference
  [LY_AC] = LAYOUT(
    ___,        ___,       ___,      KC_P,        KC_G,    /**/  ___,      ___,       KC_U,       ___,       ___,
    KC_A,       KC_R,      KC_S,     KC_T,        ___,     /**/  ___,      ___,       KC_E,       KC_I,      KC_O,
    ___,        ___,       KC_C,     ___,         ___,     /**/  ___,      ___,       ___,        ___,       ___,
    /*,         ,          ,         */KC_LSFT,   ___,     /**/  ___,      ___
  ),
